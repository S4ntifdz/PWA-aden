...
${((item.product_details?.price || item.offer_details?.price || 0) * item.quantity).toFixed(2)}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#3C647C] border-t border-gray-200 dark:border-gray-700 p-4">
        <button
          ...
          disabled={processing}
          className="w-full bg-[#80D580]-500 hover:bg-[#80D580]-600 disabled:bg-gray-400 text-white py-3 rounded-lg font-medium transition-colors flex items-center justify-center"
        >
          {processing ? (
