...
export function OffersCarousel({ offers }: OffersCarouselProps) {
  ...
  return (
    <div className="bg-white dark:bg-[#3C647C] rounded-lg p-4 shadow-sm border border-gray-200 dark:border-gray-700 mb-6">
      ...
      <div className="relative overflow-hidden rounded-lg">
        ...
        >
          {offers.map((offer) => (
            <div
              key={offer.uuid}
              className="w-full flex-shrink-0 bg-gradient-to-r from-[#8fa7b4] to-[#88b188] p-6 text-white"
            >
